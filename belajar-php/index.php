...
<head>
    ...
    initial-scale=1.0">
    <link rel="stylesheet" type="text/css" href="assets/css/profil2.css">
</head>
<body>
    <nav>
    ...
    <section id="box-profile">
       <div class="img-profile">
            <div class="photo" style="background-image:url(assets/img/nayaa.jpg);"></div>
       </div>
    ...
    <div class="information">
        ...
        <div class="data">
            ...
            <p id="pContact" class="text-gray"><?php echo $experience; ?></p>
        </div>
        <div class="data">
